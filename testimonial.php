<?php
$file='admin_panel/include/testimonialContent.txt';
$testimoialContent = file_get_contents($file);
?>
<!DOCTYPE html>
...
<body>
	...
	<div class="bodyWrapper">
		...
		<div class="textPageContent">
			<h2 class='page_heading'><span> Testimonials </span></h2>
			<div class="textPagePara">
				<?php 
					echo $testimoialContent;
				?>
			</div>
		</div>
	</div>
