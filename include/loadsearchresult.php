...
if($_POST['page'])
{
	if($search_query == NULL or $search_query==""){
		header('Location: ../404-page-not-found.html');
	}
	$sql = "select * from craft where craftName like '$search_query%' and craftIsdeleted = 'N'";
	$sql_count = "select count(*) from craft where craftName like '$search_query%' and craftIsdeleted = 'N'";
